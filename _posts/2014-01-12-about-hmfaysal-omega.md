...
* Beautifully crafted [404 page]({{ /mysite }}/404.html)
* Custom [categories]({{ /mysite }}/categories/) and [tags]({{ /mysite }}/tags/) pages for viewers pleasure
...
Having a problem getting something to work or want to know why I setup something in a certain way? Read the [theme documentation]({{ /mysite }}/documentation/) or ping me on Twitter [@hmfaysal](http://twitter.com/hmfaysal) or [file a GitHub Issue](https://github.com/hmfaysal/hmfaysal-omega-theme/issues/new).
