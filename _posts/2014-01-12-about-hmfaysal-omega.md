...
* Beautifully crafted [404 page](/mysite/{{ site.url }}/404.html)
* Custom [categories](/mysite/{{ site.url }}/categories/) and [tags](/mysite/{{ site.url }}/tags/) pages for viewers pleasure
...
Having a problem getting something to work or want to know why I setup something in a certain way? Read the [theme documentation](/mysite/{{ site.url }}/documentation/) or ping me on Twitter [@hmfaysal](http://twitter.com/hmfaysal) or [file a GitHub Issue](https://github.com/hmfaysal/hmfaysal-omega-theme/issues/new).
