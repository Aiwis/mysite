...
Check out [this post]({{ siteurl }}/articles/sample-post-images/) to learn about including images in your post.
...
Learn more about syntax highlighting [in this post]({{ siteurl }}/articles/code-highlighting-post/).
...
For more column combinations, visit [this post]({{ siteurl }}/personal/fancy-columns/).
