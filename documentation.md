...
1. [Install Jekyll](http://jekyllrb.com) and read through [this installation instructions]({{ /mysite }}/theme-setup/installing-jekyll-on-windows/) if you haven't already.
...
<figure>
  <img src="{{ /mysite }}/images/simple-search-screenshot.jpg" alt="search screenshot">
...
<figure>
<img src="{{ /mysite }}/images/twitter-card-summary-large-image.jpg" alt="search screenshot">
</figure>
...
This theme is free and open source software, distributed under the [The MIT License]({{ /mysite }}/license/). So feel free to use this Jekyll theme on your site without linking back to me or using a disclaimer.
